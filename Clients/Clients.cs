...
namespace Course_work
{
    public partial class Clients : Form
    {
        ...
        private void AddButton_Click(object sender, EventArgs e)
        {
            ...
            string sql_update_current_car = $"INSERT INTO Cars ( FIO, DateOfBirth, NumberPhone, Email, InsurancePolicy, InsurancePayment )" +
                                            $"VALUES ('{FIO}', '{DateOfBirth}', '{NumberPhone}', '{Email}', '{InsurancePolicy}', '{InsurancePayment}')";
